...
export default function Unit14LessonPage() {
  const data = getLessonsData(UNIT);
  const [lesson1, lesson2, lesson3] = data.lessons;
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <section className="bg-surface rounded-2xl border border-border p-6 mb-6 shadow-sm" aria-labelledby="lesson3-heading">
        <h2 id="lesson3-heading" className="text-xl font-bold text-ink mb-3 flex items-center gap-2">
        ...
        <p className="text-ink-light mb-4 leading-relaxed">{lesson3.content}</p>
        {lesson3.details && (
          <div className="overflow-x-auto -mx-6 px-6">
            <table className="w-full text-sm border-collapse min-w-[480px]">
              <thead>
