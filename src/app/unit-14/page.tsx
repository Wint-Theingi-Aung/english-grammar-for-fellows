...
export default function Unit14OverviewPage() {
  ...
  const objectives = [
    "Use 'want' followed by a noun to express desires",
    "Use 'want to' before a verb to express what you wish to do",
    "Use 'want (obj) to' to express what you want someone else to do",
  ];
