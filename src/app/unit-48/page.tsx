...
export default function Unit48OverviewPage() {
  ...
  const objectives = [
    "Learn to translate Myanmar sentences into English",
    "Understand sentence structure and phrase divisions",
    "Practice translating complex sentences with multiple clauses",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 48: {lessonsData.title}</h1></div>
