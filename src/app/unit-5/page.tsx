...
export default function Unit5OverviewPage() {
  ...
  const objectives = [
    "Identify and use all wh-question words: who, what, when, where, why, which, how, whom, whose",
    "Form correct wh-questions using Wh-word + auxiliary + subject + main verb",
    "Use 'how + adjective/adverb' combinations for quantity, distance, age, and manner",
    "Match the appropriate wh-word to the type of information being requested",
  ];
