...
export default function Unit28OverviewPage() {
  ...
  const objectives = [
    "Learn to combine two sentences using 'both \u2026 and'",
    "Understand subject-verb agreement with 'both \u2026 and'",
    "Use 'both \u2026 and' to connect nouns, adjectives, and verbs",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 28: {lessonsData.title}</h1></div>
