...
export default function Unit22OverviewPage() {
  ...
  const objectives = [
    "Transform 'too … to' sentences into 'so … that' sentences",
    "Transform 'so … that' sentences into 'too … to' sentences",
    "Understand the relationship between these two structures",
  ];
