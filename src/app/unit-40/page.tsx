...
export default function Unit40OverviewPage() {
  ...
  const objectives = [
    "Use 'much' in negative sentences and questions with uncountable nouns",
    "Use 'many' in negative sentences and questions with plural countable nouns",
    "Use 'a lot of' with countable and uncountable nouns",
    "Use 'a lot' (without 'of') when no noun follows",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 40: {lessonsData.title}</h1></div>
