...
export default function Unit47OverviewPage() {
  ...
  const objectives = [
    "Learn 55 common English proverbs and their meanings",
    "Understand the wisdom and advice conveyed by each proverb",
    "Practice identifying and using proverbs in context through exercises",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 47: {lessonsData.title}</h1></div>
