...
export default function Unit46OverviewPage() {
  ...
  const objectives = [
    "Learn 21 common English idioms with their meanings and usage",
    "Understand the figurative meaning behind everyday idiomatic expressions",
    "Practice identifying and using idioms in context through exercises",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 46: {lessonsData.title}</h1></div>
