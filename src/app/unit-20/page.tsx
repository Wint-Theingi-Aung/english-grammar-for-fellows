...
export default function Unit20OverviewPage() {
  ...
  const objectives = [
    "Use 'too + adjective + to + V1' to express undesirable excess",
    "Use 'too + adjective + for someone + to + V1' when the subject differs",
    "Combine two sentences into one using 'too ... to'",
  ];
