...
export default function Unit15OverviewPage() {
  ...
  const objectives = [
    "Use 'would like' followed by a noun for polite requests",
    "Use 'would like to' before a verb for polite expressions",
    "Use 'would like (obj) to' to express polite wishes about others",
  ];
