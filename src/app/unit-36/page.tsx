...
export default function Unit36OverviewPage() {
  ...
  const objectives = [
    "Know the adverbs of frequency from always (100%) to never (0%)",
    "Place adverbs of frequency before the main verb",
    "Place adverbs of frequency after the verb to be",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 36: {lessonsData.title}</h1></div>
