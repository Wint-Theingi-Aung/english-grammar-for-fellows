...
export default function Unit34OverviewPage() {
  ...
  const objectives = [
    "Know when to use a/an with singular countable nouns",
    "Know when to use 'the' for specific or previously mentioned things",
    "Know when to use no article for general statements",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 34: {lessonsData.title}</h1></div>
