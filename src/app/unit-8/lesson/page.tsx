...
export default function Unit8LessonPage() {
  const data = getLessonsData(UNIT);
  const [canLesson, couldLesson, comparisonLesson] = data.lessons;
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <section className="bg-surface rounded-2xl border border-border p-6 mb-6 shadow-sm" aria-labelledby="can-heading">
        <h2 id="can-heading" className="text-xl font-bold text-ink mb-3 flex items-center gap-2">
        ...
        <p className="text-ink-light mb-4 leading-relaxed">{canLesson.content}</p>
        {canLesson.details && (
      ...
      <section className="bg-surface rounded-2xl border border-border p-6 mb-6 shadow-sm" aria-labelledby="could-heading">
        <h2 id="could-heading" className="text-xl font-bold text-ink mb-3 flex items-center gap-2">
        ...
        <p className="text-ink-light mb-4 leading-relaxed">{couldLesson.content}</p>
        {couldLesson.details && (
          <div className="overflow-x-auto -mx-6 px-6">
            <table className="w-full text-sm border-collapse min-w-[480px]">
              <thead>
