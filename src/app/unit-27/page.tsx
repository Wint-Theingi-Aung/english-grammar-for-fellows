...
export default function Unit27OverviewPage() {
  ...
  const objectives = [
    "Learn to use 'neither \u2026 nor' to connect negative alternatives",
    "Understand subject-verb agreement with 'neither \u2026 nor'",
    "Combine two negative sentences using 'neither \u2026 nor'",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 27: {lessonsData.title}</h1></div>
