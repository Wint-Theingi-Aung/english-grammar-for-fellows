...
export default function Unit3OverviewPage() {
  ...
  const objectives = [
    "Understand and use 'have', 'has', and 'had' as a main verb for possession",
    "Form affirmative, negative, interrogative, and negative-interrogative sentences with 'have'",
    "Use 'have/has/had' as an auxiliary verb in present perfect, past perfect, and future perfect tenses",
    "Reply to Yes/No questions with short and long answers using 'have'",
  ];
