...
export default function Unit13OverviewPage() {
  ...
  const objectives = [
    "Use 'seem' with adjectives to describe appearances",
    "Use 'seem to' before verbs to express how things appear",
    "Form negatives and questions with 'seem' and 'seem to'",
  ];
