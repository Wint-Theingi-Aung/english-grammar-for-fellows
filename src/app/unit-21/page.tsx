...
export default function Unit21OverviewPage() {
  ...
  const objectives = [
    "Use 'so + adjective/adverb + that + result' to show cause and effect",
    "Combine two sentences into one using 'so … that'",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 21: {lessonsData.title}</h1></div>
