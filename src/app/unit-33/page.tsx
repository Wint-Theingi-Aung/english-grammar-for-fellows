...
export default function Unit33OverviewPage() {
  ...
  const objectives = [
    ...
    "Learn to identify which nouns are countable and which are uncountable",
    "Know when to use quantifiers like 'some', 'a lot of' with each type",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 33: {lessonsData.title}</h1></div>
