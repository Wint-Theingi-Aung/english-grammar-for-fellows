...
export default function Unit42OverviewPage() {
  ...
  const objectives = [
    "Use the Positive Degree to describe one person or thing",
    "Use the Comparative Degree to compare two persons or things",
    "Use the Superlative Degree to compare more than two persons or things",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 42: {lessonsData.title}</h1></div>
