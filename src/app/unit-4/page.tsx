...
export default function Unit4OverviewPage() {
  ...
  const objectives = [
    "Understand the rules for forming question tags",
    "Form positive statement with negative tag and negative statement with positive tag",
    "Use correct auxiliary verbs in question tags for different tenses",
    "Handle special cases: imperative, let's, nobody/nothing, and 'I am'",
  ];
