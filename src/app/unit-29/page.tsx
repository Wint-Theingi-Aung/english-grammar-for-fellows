...
export default function Unit29OverviewPage() {
  ...
  const objectives = [
    "Learn to connect and emphasize two phrases using 'not only \u2026 but also'",
    "Understand parallelism with 'not only \u2026 but also'",
    "Maintain subject-verb agreement with 'not only \u2026 but also'",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 29: {lessonsData.title}</h1></div>
