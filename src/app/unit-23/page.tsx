...
export default function Unit23OverviewPage() {
  ...
  const objectives = [
    "Use 'such + a/an + adjective + noun + that + result' to give reasons",
    "Combine two sentences into one using 'such … that'",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 23: {lessonsData.title}</h1></div>
