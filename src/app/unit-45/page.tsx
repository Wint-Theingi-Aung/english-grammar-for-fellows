...
export default function Unit45OverviewPage() {
  ...
  const objectives = [
    "Learn 25 common English phrasal verbs with their meanings",
    "Understand how phrasal verbs change meaning with different prepositions",
    "Practice using phrasal verbs in context through multiple-choice exercises",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 45: {lessonsData.title}</h1></div>
