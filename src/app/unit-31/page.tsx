...
export default function Unit31OverviewPage() {
  ...
  const objectives = [
    "Learn to combine two sentences using 'No sooner … than'",
    "Use the correct auxiliary: did + V1 for simple past, had + V3 for past perfect",
    "Preserve the correct tense sequence when rewriting sentences",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 31: {lessonsData.title}</h1></div>
