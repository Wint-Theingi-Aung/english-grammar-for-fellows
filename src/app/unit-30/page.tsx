...
export default function Unit30OverviewPage() {
  ...
  const objectives = [
    "Learn to join two sentences using 'as soon as'",
    "Replace 'when', 'at once', 'immediately' with 'as soon as'",
    "Preserve correct tense sequence when rewriting sentences",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 30: {lessonsData.title}</h1></div>
