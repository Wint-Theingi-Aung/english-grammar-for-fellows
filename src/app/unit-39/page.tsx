...
export default function Unit39OverviewPage() {
  ...
  const objectives = [
    "Use 'some' with uncountable and plural countable nouns in affirmative sentences",
    "Use 'any' with uncountable and plural countable nouns in negative sentences and questions",
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 39: {lessonsData.title}</h1></div>
