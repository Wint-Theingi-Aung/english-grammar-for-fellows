...
export default function Unit26OverviewPage() {
  ...
  const objectives = [
    "Learn to use 'either \u2026 or' to connect alternatives",
    "Understand subject-verb agreement with 'either \u2026 or'",
    "Combine two sentences using 'either \u2026 or'",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 26: {lessonsData.title}</h1></div>
