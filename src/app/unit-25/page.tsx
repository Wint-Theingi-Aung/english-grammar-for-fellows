...
export default function Unit25OverviewPage() {
  ...
  const objectives = [
    "Learn to form double comparatives using 'the + comparative, the + comparative'",
    "Express cause and effect relationships using double comparatives",
    "Transform simple sentences into double comparative structures",
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10 lg:py-12">
      ...
      <div className="mb-8"><h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2 tracking-tight">Unit 25: {lessonsData.title}</h1></div>
