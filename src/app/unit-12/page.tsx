...
export default function Unit12OverviewPage() {
  ...
  const objectives = [
    "Understand when to use 'need' as a main verb followed by a noun",
    "Use 'need to' before a verb to express necessity",
    "Form negatives and questions with 'need' and 'need to'",
  ];
